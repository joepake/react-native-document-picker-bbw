...
public class FileListAdapter extends BaseAdapter {
    ...
    private class ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            if (FilePickerDialog.isDarkMode) {
                rbSingleMode.setSupportButtonTintList(ColorStateList.valueOf(Color.WHITE));
                cbMultiMode.setSupportButtonTintList(ColorStateList.valueOf(Color.WHITE));
